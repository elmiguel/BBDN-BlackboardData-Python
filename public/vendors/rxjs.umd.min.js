...
*****************************************************************************/
(function (k, h) {
    "object" === typeof exports && "undefined" !== typeof module ? h(exports) : "function" === typeof define && define.amd ? define("rxjs", ["exports"], h) : h(k.rxjs = {})
})(this, function (k) {
    function h(c, a) {
        function b() {
            this.constructor = c
    ...
    function sa(c) {
        for (; c;) {
            var a = c.destination,
                b = c.isStopped;
            if (c.closed || b) return !1;
            c = a && a instanceof m ? a : null
        }
        return !0
    }
    ...
    function Z(c, a) {
        return a ? va(c, a) : new n(Na(c))
    }

    function ga() {
        for (var c = [], a = 0; a < arguments.length; a++) c[a] = arguments[a];
        a = c[c.length - 1];
        return A(a) ? (c.pop(), va(c, a)) : Z(c)
    }

    function wa(c, a) {
        return a ? new n(function (b) {
            return a.schedule(Lb, 0, {
                error: c,
                subscriber: b
            })
        }) : new n(function (b) {
                ...
                if (!g) {
                    ...
                    try {
                        c.apply(f, a.concat([function () {
                            ...
                            g.next(1 >= b.length ? b[0] : b);
                            g.complete()
                        }]))
                    } catch (K) {
                        sa(g) ? g.error(K) : console.warn(K)
                    }
                }
        ...
        if (a)
            if (A(a)) b = a;
                ...
                for (var d = [], e = 0; e < arguments.length; e++) d[e] =
                    arguments[e];
                return Pa(c, b).apply(void 0, d).pipe(B(function (b) {
                    return x(b) ? a.apply(void 0, b) : a(b)
                }))
            };
        return function () {
        ...
        if (!l) {
            ...
            try {
                e.apply(c, f.concat([function () {
                    for (var b = [], c = 0; c < arguments.length; c++) b[c] = arguments[c];
                    (c = b.shift()) ? a.add(g.schedule(Qa, 0, {
                        err: c,
                        subject: l
                    })): a.add(g.schedule(Qb, 0, {
                        value: 1 >= b.length ? b[0] : b,
                        subject: l
                    }))
                }]))
    ...
    function Sa(c, a) {
        if (null != c) {
            ...
            if (c && "function" === typeof c[E] || "string" === typeof c) return Tb(c, a)
        }
    ...
    function L(c, a, b) {
        ...
        if ("function" === typeof a) return function (d) {
            return d.pipe(L(function (b, d) {
                return F(c(b, d)).pipe(B(function (c, e) {
                    return a(b, c, d, e)
                }))
            }, b))
        };
    ...
    function aa() {
        for (var c = [], a = 0; a <
            arguments.length; a++) c[a] = arguments[a];
    ...
    function ia(c, a) {
        return new n(function (b) {
            ...
            if (0 === d) b.complete();
                ...
                for (var e = Array(d), f = 0, g = 0, l = function (l) {
                        var h = F(c[l]),
                            u = !1;
                        b.add(h.subscribe({
                            next: function (b) {
                            ...
                            complete: function () {
                                f++;
                                f !== d && u || (g === d && b.next(a ? a.reduce(function (b, a, c) {
                                    return b[a] =
                                        e[c], b
                                }, {}) : e), b.complete())
                            }
    ...
    function Va(c, a, b, d) {
        P(b) && (d = b, b = void 0);
        return d ? Va(c, a, b).pipe(B(function (b) {
    ...
    function Wa(c, a, b, d, e) {
        var f;
        if (c && "function" === typeof c.addEventListener && "function" === typeof c.removeEventListener) c.addEventListener(a, b, e), f = function () {
            return c.removeEventListener(a, b, e)
        };
        else if (c && "function" ===
            typeof c.on && "function" === typeof c.off) c.on(a, b), f = function () {
            return c.off(a, b)
        };
        else if (c && "function" === typeof c.addListener && "function" === typeof c.removeListener) c.addListener(a, b), f = function () {
    ...
    function Xa(c, a, b) {
        return b ? Xa(c, a).pipe(B(function (a) {
    ...
    function Ya() {
        ...
        var a = Number.POSITIVE_INFINITY,
            b = null,
            d = c[c.length - 1];
        A(d) ? (b = c.pop(), 1 < c.length && "number" === typeof c[c.length - 1] && (a = c.pop())) : "number" === typeof d && (a = c.pop());
        return null === b && 1 === c.length && c[0] instanceof n ? c[0] : xa(a)(Z(c, b))
    }
    ...
    function za() {
        ...
        var b = c[0],
            d = c.slice(1);
        return 1 === c.length && x(b) ? za.apply(void 0, b) : new n(function (a) {
            var c = function () {
    ...
    function cc(c) {
        var a = c.start,
            b = c.index,
            d = c.subscriber;
        b >= c.count ? d.complete() : (d.next(a), d.closed || (c.index = b + 1, c.start = a + 1, this.schedule(c)))
    }
    ...
    function fc(c) {
        var a = c.bufferCreationInterval,
            ...
            e = c.scheduler,
            f = d.openContext();
        d.closed || (d.add(f.closeAction = e.schedule(fb, b, {
            subscriber: d,
            context: f
        })), this.schedule(c, a))
    }
    ...
    function ib(c, a) {
        return a ? function (b) {
            return b.pipe(ib(function (b, e) {
                return F(c(b, e)).pipe(B(function (c, d) {
                    return a(b, c, e, d)
                }))
            }))
        } : function (b) {
    ...
    function ma(c, a) {
        return 2 <= arguments.length ? function (b) {
            return ta(la(c, a), ka(1), ba(a))(b)
        } : function (b) {
            return ta(la(function (b, a, f) {
                return c(b, a, f + 1)
            }), ka(1))(b)
        }
    }
    ...
    function M(c, a) {
        return function (b) {
            var d;
            d = "function" === typeof c ? c : function () {
                return c
            };
    ...
    function uc(c) {
        ...
        return function (a) {
            l++;
            if (!g || k) k = !1, g = new W(b, d, f), h = a.subscribe({
                next: function (b) {
                    g.next(b)
                },
                error: function (b) {
    ...
    function mb(c, a) {
        switch (c) {
            case "json":
                return c = "response" in a ? a.responseType ? a.response : JSON.parse(a.response || a.responseText || "null") : JSON.parse(a.responseText || "null"), c;
            case "xml":
    ...
    instanceof Array && function (c, a) {
            ...
            next: function (c) {},
            error: function (c) {
                if (C.useDeprecatedSynchronousErrorHandling) throw c;
                Q(c)
            },
            complete: function () {}
        }, x = function () {
            ...
            c.prototype.unsubscribe = function () {
                ...
                if (!this.closed) {
                    ...
                    this.closed = !0;
                    this._subscriptions = this._parentOrParents = null;
                    if (b instanceof c) b.remove(this);
                    else if (null !== b)
                        for (var f = 0; f < b.length; ++f) b[f].remove(this);
                    if (P(d)) try {
                        d.call(this)
                    } catch (g) {
                        a =
                    ...
                    if (x(e))
                        for (f = -1, b = e.length; ++f < b;)
                            if (d = e[f], ra(d)) try {
                                d.unsubscribe()
                            } catch (g) {
                                a = a || [], g instanceof Y ? a = a.concat(Ka(g.errors)) : a.push(g)
                            }
                    if (a) throw new Y(a);
                }
            };
            c.prototype.add = function (a) {
                ...
                switch (typeof a) {
                    ...
                    case "object":
                        ...
                        b instanceof c || (a = b, b = new c, b._subscriptions = [a]);
                        break;
                    default:
                        throw Error("unrecognized teardown " +
                            a + " added to Subscription.");
                }
                a = b._parentOrParents;
                if (null === a) b._parentOrParents = this;
                else if (a instanceof c) {
                    if (a === this) return b;
                    b._parentOrParents = [a, this]
                } else if (-1 === a.indexOf(this)) a.push(this);
                else return b;
                a = this._subscriptions;
                null === a ? this._subscriptions = [b] : a.push(b);
                return b
            };
        ...
        "@@rxSubscriber_" + Math.random(), m = function (c) {
            function a(b, d, e) {
                ...
                switch (arguments.length) {
                    ...
                    case 1:
                        ...
                        if ("object" === typeof b) {
                            b instanceof a ? (f.syncErrorThrowable = b.syncErrorThrowable, f.destination = b, b.add(f)) : (f.syncErrorThrowable = !0, f.destination = new nb(f, b));
                            break
                        }
                        default:
            ...
            function a(b, a, e, f) {
                ...
                var l;
                b = d;
                P(a) ? l = a : a && (l = a.next, e = a.error, f = a.complete, a !== na &&
                    (b = Object.create(a), P(b.unsubscribe) && d.add(b.unsubscribe.bind(b)), b.unsubscribe = d.unsubscribe.bind(d)));
                d._context = b;
                d._next = l;
                d._error = e;
                d._complete = f;
            ...
            a.prototype.next = function (b) {
                if (!this.isStopped && this._next) {
                    ...
                    C.useDeprecatedSynchronousErrorHandling && a.syncErrorThrowable ? this.__tryOrSetError(a, this._next, b) && this.unsubscribe() : this.__tryOrUnsub(this._next, b)
                }
            };
            a.prototype.error = function (b) {
                if (!this.isStopped) {
                    var a = this._parentSubscriber,
                        c = C.useDeprecatedSynchronousErrorHandling;
                    if (this._error) c && a.syncErrorThrowable ? this.__tryOrSetError(a, this._error, b) : this.__tryOrUnsub(this._error, b), this.unsubscribe();
                    else if (a.syncErrorThrowable) c ? (a.syncErrorValue = b, a.syncErrorThrown = !0) : Q(b), this.unsubscribe();
                    else {
                        this.unsubscribe();
                        if (c) throw b;
                        Q(b)
            ...
            a.prototype.complete = function () {
                ...
                if (!this.isStopped) {
                    ...
                    if (this._complete) {
                        ...
                        C.useDeprecatedSynchronousErrorHandling && a.syncErrorThrowable ? this.__tryOrSetError(a,
            ...
            a.prototype.__tryOrSetError = function (b, a, c) {
                ...
                try {
                    ...
                    return C.useDeprecatedSynchronousErrorHandling ? (b.syncErrorValue = f, b.syncErrorThrown = !0) : Q(f), !0
                }
                return !1
            };
            ...
            c.prototype.subscribe = function (a, b, c) {
                ...
                a: {
                    if (a) {
                        if (a instanceof m) break a;
                        if (a[oa]) {
                            a = a[oa]();
                            break a
                        }
                    }
                    a = a || b || c ? new m(a, b, c) : new m(na)
                }
                d ? a.add(d.call(a, this.source)) : a.add(this.source || C.useDeprecatedSynchronousErrorHandling &&
                    !a.syncErrorThrowable ? this._subscribe(a) : this._trySubscribe(a));
                if (C.useDeprecatedSynchronousErrorHandling && a.syncErrorThrowable && (a.syncErrorThrowable = !1, a.syncErrorThrown)) throw a.syncErrorValue;
                return a
            };
            c.prototype._trySubscribe = function (a) {
                try {
                    ...
                    C.useDeprecatedSynchronousErrorHandling && (a.syncErrorThrown = !0, a.syncErrorValue = b), sa(a) ? a.error(b) : console.warn(b)
                }
            };
            ...
            c.prototype.pipe = function () {
                ...
                return 0 === a.length ? this : La(a)(this)
            };
            ...
            a.prototype.next = function (b) {
                ...
                if (!this.isStopped)
                    for (var a = this.observers, c = a.length, a = a.slice(), f = 0; f < c; f++) a[f].next(b)
            };
            a.prototype.error = function (b) {
                if (this.closed) throw new I;
                this.hasError = !0;
                this.thrownError = b;
                this.isStopped = !0;
                for (var a = this.observers, c = a.length, a = a.slice(), f = 0; f < c; f++) a[f].error(b);
            ...
            a.prototype._trySubscribe = function (b) {
                if (this.closed) throw new I;
                return c.prototype._trySubscribe.call(this,
                    b)
            };
        ...
        Jc = function (c) {
            ...
            a.prototype.connect = function () {
                ...
                b || (this._isComplete = !1, b = this._connection = new t, b.add(this.source.subscribe(new Kc(this.getSubject(), this))), b.closed && (this._connection = null, b = t.EMPTY));
                return b
            };
    ...
    var Mc = function () {
            ...
            c.prototype.call = function (a, b) {
                return b.subscribe(new Lc(a, this.keySelector, this.elementSelector, this.durationSelector, this.subjectSelector))
            };
            return c
        }(),
        Lc = function (c) {
            ...
            a.prototype._group = function (b, a) {
                ...
                if (!d && (d = this.subjectSelector ? this.subjectSelector() :
                        new v, c.set(a, d), b = new Da(a, d, this), this.destination.next(b), this.durationSelector)) {
                    b = void 0;
                    try {
        ...
        ea = function (c) {
            ...
            a.prototype.requestAsyncId = function (b, a, c) {
                void 0 === c && (c = 0);
                return setInterval(b.flush.bind(b, this),
                    c)
            };
            a.prototype.recycleAsyncId = function (b, a, c) {
                void 0 === c && (c = 0);
                if (null !== c && this.delay === c && !1 === this.pending) return a;
                clearInterval(a)
            };
            ...
            a.prototype._unsubscribe = function () {
                ...
                this.pending = !1;
                this.scheduler = null; - 1 !== f && c.splice(f, 1);
        ...
        Pc = function (c) {
            ...
            a.prototype.requestAsyncId = function (b, a, e) {
                void 0 === e && (e = 0);
                return null !== e && 0 < e || null === e && 0 < this.delay ? c.prototype.requestAsyncId.call(this, b, a, e) : b.flush(this)
            };
            return a
        }(ea),
        Ea = function () {
        ...
        O = function (c) {
            ...
            h(a, c);
            a.prototype.schedule = function (b, d, e) {
                void 0 === d && (d = 0);
                return a.delegate && a.delegate !== this ? a.delegate.schedule(b, d, e) : c.prototype.schedule.call(this,
                    b, d, e)
            };
        ...
        Na = function (c) {
            return function (a) {
                for (var b = 0, d = c.length; b < d && !a.closed; b++) a.next(c[b]);
                a.complete()
            }
        };
    (function (c) {
        ...
        c.ERROR = "E";
        c.COMPLETE = "C"
    })(k.NotificationKind || (k.NotificationKind = {}));
    var w = function () {
            function c(a, b, c) {
                this.kind = a;
                this.value = b;
        ...
        tb = function (c) {
            ...
            a.prototype._error = function (b) {
                this.scheduleMessage(w.createError(b));
                this.unsubscribe()
            };
            a.prototype._complete = function () {
        ...
        W = function (c) {
            function a(b, a, e) {
                ...
                d.scheduler = e;
                d._events = [];
                d._infiniteTimeWindow = !1;
                d._bufferSize = 1 > b ? 1 : b;
                d._windowTime = 1 > a ? 1 : a;
                a === Number.POSITIVE_INFINITY ? (d._infiniteTimeWindow = !0, d.next = d.nextInfiniteTimeWindow) : d.next = d.nextTimeWindow;
                return d
            }
            h(a, c);
            ...
            a.prototype._subscribe = function (b) {
                var a = this._infiniteTimeWindow,
                    ...
                    l;
                if (this.closed) throw new I;
                this.isStopped || this.hasError ? l = t.EMPTY : (this.observers.push(b), l = new ob(this, b));
                f && b.add(b = new tb(b, f));
                if (a)
                    for (a = 0; a < g && !b.closed; a++) b.next(c[a]);
                else
                    for (a = 0; a < g && !b.closed; a++) b.next(c[a].value);
            ...
            a.prototype._trimBufferThenGetEvents = function () {
                for (var b = this._getNow(), a = this._bufferSize, c = this._windowTime, f = this._events, g = f.length, l = 0; l < g && !(b - f[l].time < c);) l++;
                g > a && (l = Math.max(l, g - a));
                0 < l && f.splice(0, l);
                return f
            };
            return a
        ...
        Uc = function (c) {
            ...
            a.prototype.requestAsyncId = function (b, a, e) {
                void 0 === e && (e = 0);
                if (null !== e && 0 < e) return c.prototype.requestAsyncId.call(this, b, a, e);
                b.actions.push(this);
                return b.scheduled || (b.scheduled = ub.setImmediate(b.flush.bind(b, null)))
            };
            a.prototype.recycleAsyncId = function (b, a, e) {
                void 0 === e && (e = 0);
                if (null !== e && 0 < e || null === e && 0 < this.delay) return c.prototype.recycleAsyncId.call(this, b, a, e);
                0 === b.actions.length && (ub.clearImmediate(a), b.scheduled = void 0)
            };
            return a
        }(ea),
        pa = new(function (c) {
            ...
            a.prototype.flush = function (b) {
                ...
                b = b || a.shift();
                do
                    if (c = b.execute(b.state, b.delay)) break; while (++f < g && (b = a.shift()));
                this.active = !1;
                if (c) {
        ...
        Vc = function (c) {
            ...
            a.prototype.recycleAsyncId = function (b, a, e) {
                void 0 === e && (e = 0);
                if (null !== e && 0 < e || null === e && 0 < this.delay) return c.prototype.recycleAsyncId.call(this,
                    b, a, e);
        ...
        vb = function (c) {
            ...
            a.prototype.flush = function () {
                for (var b = this.actions, a = this.maxFrames, c, f;
                    (f = b[0]) && f.delay <= a && !(b.shift(), this.frame = f.delay, c = f.execute(f.state, f.delay)););
                if (c) {
        ...
        Ga = function (c) {
            ...
            h(a, c);
            a.prototype.schedule = function (b, d) {
                void 0 === d && (d = 0);
                if (!this.id) return c.prototype.schedule.call(this, b, d);
                this.active = !1;
                var e = new a(this.scheduler, this.work);
                this.add(e);
                return e.schedule(b, d)
            };
    ...
    var Zc = function (c) {
        ...
        dd = function (c) {
            ...
            a.prototype.notifyNext = function (b, a, c, f, g) {
                if (!this.hasFirst) {
                    this.hasFirst = !0;
                    for (b = 0; b < this.subscriptions.length; b++) b !==
                        c && (f = this.subscriptions[b], f.unsubscribe(), this.remove(f));
        ...
        ed = function (c) {
            ...
            a.prototype._complete = function () {
                ...
                if (0 === a) this.destination.complete();
                    ...
                    for (var c = 0; c < a; c++) {
                        var f = b[c];
                        f.stillUnsubscribed ? this.destination.add(f.subscribe(f, c)) : this.active--
                    }
                }
            };
            ...
            a.prototype.checkIterators = function () {
                for (var b =
                        this.iterators, a = b.length, c = this.destination, f = 0; f < a; f++) {
                    var g = b[f];
                    if ("function" === typeof g.hasValue && !g.hasValue()) return
                }
                ...
                this.resultSelector ? this._tryresultSelector(h) : c.next(h);
                l && c.complete()
            };
            a.prototype._tryresultSelector = function (b) {
                var a;
        ...
        id = function (c) {
            ...
            a.prototype._next = function (b) {
                ...
                if (!this.throttled) {
                    ...
                    b = p(this, a);
                    !b || b.closed ? this.clearThrottle() : this.add(this.throttled = b)
                }
            };
        ...
        od = function (c) {
            function a(b, a, e, f, g) {
                b = c.call(this, b) || this;
                b.bufferTimeSpan = a;
                b.bufferCreationInterval = e;
                b.maxBufferSize = f;
                b.scheduler = g;
                b.contexts = [];
                f = b.openContext();
                b.timespanOnly = null == e || 0 > e;
                if (b.timespanOnly) b.add(f.closeAction = g.schedule(eb, a, {
                    subscriber: b,
                    context: f,
                    bufferTimeSpan: a
                }));
                    ...
                    b.add(f.closeAction = g.schedule(fb, a, {
                        subscriber: b,
                        context: f
                    }));
            ...
            a.prototype._next = function (b) {
                for (var a = this.contexts, c = a.length, f, g = 0; g < c; g++) {
                    var l = a[g],
                        h = l.buffer;
                    h.push(b);
                    h.length == this.maxBufferSize && (f = l)
                }
            ...
            a.prototype.onBufferFull = function (b) {
                ...
                if (!this.closed && this.timespanOnly) {
                    ...
                    this.add(b.closeAction = this.scheduler.schedule(eb, a, {
                        subscriber: this,
                        context: b,
                        bufferTimeSpan: a
                    }))
            ...
            a.prototype.closeContext = function (b) {
                ...
                var a = this.contexts;
                0 <= (a ? a.indexOf(b) : -1) && a.splice(a.indexOf(b),
                    1)
            };
            return a
        }(m),
        ...
        rd = function (c) {
            ...
            h(a, c);
            a.prototype._next = function (b) {
                for (var a = this.contexts, c = a.length, f = 0; f < c; f++) a[f].buffer.push(b)
            };
            a.prototype._error = function (b) {
        ...
        td = function (c) {
            ...
            a.prototype.openBuffer = function () {
                ...
                this.closingSubscription = b = new t;
                this.add(b);
                this.subscribing = !0;
                b.add(p(this, a));
                this.subscribing = !1
        ...
        zd = function (c) {
            ...
            a.prototype._tryNext = function (b, a) {
                ...
                (c = p(this, a)) && !c.closed && this.add(this.durationSubscription = c)
            };
            a.prototype.notifyNext = function (b, a, c, f, g) {
                this.emitValue()
            };
            ...
            a.prototype.emitValue = function () {
                if (this.hasValue) {
                    ...
                    a && (this.durationSubscription =
                        null, a.unsubscribe(), this.remove(a));
                    this.value = null;
                    this.hasValue = !1;
        ...
        Bd = function (c) {
            ...
            a.prototype._next = function (b) {
                ...
                this.lastValue =
                    b;
                this.hasValue = !0;
                this.add(this.debouncedSubscription = this.scheduler.schedule(gc, this.dueTime, this))
            };
            a.prototype._complete = function () {
                this.debouncedNext();
                this.destination.complete()
        ...
        Ed = function (c) {
            ...
            h(a, c);
            a.dispatch = function (b) {
                for (var a = b.source, c = a.queue, f = b.scheduler, g = b.destination; 0 < c.length && 0 >= c[0].time - f.now();) c.shift().notification.observe(g);
                0 < c.length ? (a = Math.max(0, c[0].time - f.now()), this.schedule(b, a)) : (this.unsubscribe(), a.active = !1)
            };
            a.prototype._schedule =
                function (b) {
                    this.active = !0;
                    this.destination.add(b.schedule(a.dispatch, this.delay, {
                        source: this,
        ...
        Od = function (c) {
            ...
            a.prototype._next = function (b) {
                ...
                c || (this.key = a, this.destination.next(b))
            };
            return a
        }(m),
        kc = function () {
        ...
        Wd = function (c) {
            function a(b,
                ...
                b.active = 0;
                b.hasCompleted = !1;
                e < Number.POSITIVE_INFINITY && (b.buffer = []);
                return b
            }
            h(a, c);
            a.dispatch = function (b) {
                        ...
                        try {
                            ...
                            this.scheduler ? this.destination.add(this.scheduler.schedule(a.dispatch,
                                0, {
                                    ...
                                    value: b,
                                    index: e
                                })) : this.subscribeToProjection(g, b, e)
                        } catch (l) {
                            c.error(l)
                        }
            ...
            a.prototype.subscribeToProjection = function (b, a, c) {
                this.active++;
                this.destination.add(p(this, b, a, c))
            };
            a.prototype._complete = function () {
        ...
        he = function (c) {
            ...
            a.prototype._error = function (b) {
                var a = this.destination;
                a.next(w.createError(b));
                a.complete()
            };
            a.prototype._complete = function () {
                var b = this.destination;
                b.next(w.createComplete());
                b.complete()
            };
            return a
        }(m),
        ...
        ke = function (c) {
            ...
            a.prototype._complete = function () {
                this.hasCompleted = !0;
                0 === this.active &&
                    0 === this.buffer.length && (!1 === this.hasValue && this.destination.next(this.acc), this.destination.complete());
                this.unsubscribe()
            };
            a.prototype.notifyNext = function (b, a, c, f, g) {
                b = this.destination;
        ...
        oe = function (c) {
            ...
            a.prototype._next = function (b) {
                var a;
                this.hasPrev ? a = [this.prev, b] : this.hasPrev = !0;
                this.prev = b;
        ...
        re = function (c) {
            ...
            a.prototype.subscribeToRetries = function () {
                ...
                try {
                    var a = this.notifier;
                    b = a(this.notifications)
                } catch (e) {
                    return c.prototype.complete.call(this)
                }
                this.retries = b;
                this.retriesSubscription = p(this, b)
            };
            return a
        }(q),
        ue =
        ...
        te = function (c) {
            ...
            a.prototype.error = function (b) {
                if (!this.isStopped) {
                    var a = this.source,
                        e = this.count;
                    if (0 === e) return c.prototype.error.call(this, b); - 1 < e && (this.count = e - 1);
        ...
        ve = function (c) {
            ...
            a.prototype.error = function (b) {
                if (!this.isStopped) {
                    ...
                    if (e) this.retriesSubscription = this.errors = null;
                    else {
                        a = new v;
                        try {
                            var g = this.notifier,
        ...
        Be = function (c) {
            ...
            a.prototype._complete = function () {
                this._oneComplete ? this.emit(0 === this._a.length &&
                    0 === this._b.length) : this._oneComplete = !0;
                this.unsubscribe()
            };
        ...
        Ee = function (c) {
            ...
            a.prototype._complete = function () {
                var b = this.destination;
                0 < this.index ? (b.next(this.seenValue ? this.singleValue : void 0), b.complete()) : b.error(new ca)
            };
            return a
        }(m),
        He = function () {
        ...
        Je = function () {
            ...
            c.prototype.call = function (a, b) {
                return 0 === this._skipCount ? b.subscribe(new m(a)) : b.subscribe(new Ie(a, this._skipCount))
            };
            return c
        }(),
        Ie = function (c) {
        ...
        Oe = function (c) {
            function a(a, d, e) {
                ...
                b.delayTime = d;
                b.scheduler = e;
                if (!V(d) || 0 > d) b.delayTime = 0;
                e && "function" === typeof e.schedule || (b.scheduler = pa);
                return b
            }
            h(a, c);
            a.create = function (b, c, e) {
        ...
        Te = function (c) {
            ...
            a.prototype.nextOrComplete = function (a, c) {
                var b = this.destination;
                c ? b.next(a) : (this.inclusive && b.next(a), b.complete())
            };
            return a
        }(m),
        We = function () {
            ...
            c.prototype.call = function (a, b) {
                return b.subscribe(new Ve(a, this.nextOrObserver, this.error, this.complete))
            };
            return c
        }(),
        Ve = function (c) {
            function a(a, d, e, f) {
                ...
                a._tapError = e || D;
                a._tapComplete = f || D;
                P(d) ? (a._context = a, a._tapNext = d) : d && (a._context = d, a._tapNext = d.next || D, a._tapError = d.error || D, a._tapComplete = d.complete || D);
                return a
            }
            h(a, c);
            a.prototype._next = function (a) {
        ...
        Ye = function () {
            ...
            c.prototype.call =
                function (a, b) {
                    return b.subscribe(new Xe(a, this.durationSelector, this.leading, this.trailing))
                };
            return c
        }(),
        Xe = function (c) {
        ...
        $e = function () {
            ...
            c.prototype.call = function (a, b) {
                return b.subscribe(new Ze(a, this.duration, this.scheduler, this.leading, this.trailing))
            };
            return c
        }(),
        Ze = function (c) {
            ...
            h(a, c);
            a.prototype._next = function (a) {
                this.throttled ? this.trailing && (this._trailingValue = a, this._hasTrailingValue = !0) : (this.add(this.throttled = this.scheduler.schedule(wc, this.duration, {
                    subscriber: this
        ...
        xc = function () {
            ...
            c.prototype.call = function (a, b) {
                return b.subscribe(new bf(a, this.absoluteTimeout, this.waitFor, this.withObservable, this.scheduler))
            };
            return c
        }(),
        bf = function (c) {
        ...
        jf = function () {
            ...
            c.prototype.call = function (a, b) {
                return b.subscribe(new hf(a, this.windowTimeSpan, this.windowCreationInterval, this.maxWindowSize, this.scheduler))
            };
            return c
        }(),
        kf = function (c) {
        ...
        hf = function (c) {
            function a(a, d, e, f, g) {
                ...
                null !== e && 0 <= e ? (f = {
                    ...
                    subscriber: b,
                    scheduler: g
                }, b.add(g.schedule(kb, d, {
                    subscriber: b,
                    window: a,
                    context: null
                })), b.add(g.schedule(Ac, e, f))) : b.add(g.schedule(zc, d, {
                    subscriber: b,
                    window: a,
                    windowTimeSpan: d
                }));
        ...
        lf = function (c) {
            function a(a, d, e) {
                ...
                a.closingSelector = e;
                a.contexts = [];
                a.add(a.openSubscription = p(a, d, d));
                return a
            }
            h(a, c);
            a.prototype._next = function (a) {
            ...
            a.prototype.notifyNext = function (a, c, e, f, g) {
                if (a === this.openings) {
                    ...
                    a = p(this, a, e);
                    a.closed ? this.closeWindow(this.contexts.length - 1) : (a.context = e, b.add(a));
                    this.destination.next(c)
        ...
        pf = function (c) {
            function a(a, d, e) {
                ...
                e = d.length;
                a.values = Array(e);
                for (var b = 0; b < e; b++) a.toRespond.push(b);
                for (b = 0; b < e; b++) {
                    var g = d[b];
                    a.add(p(a, g, g, b))
                }
        ...
        rf = Object.freeze({
            ...
            bufferTime: function (c) {
                var a = arguments.length,
                    b = y;
                A(arguments[arguments.length - 1]) && (b = arguments[arguments.length - 1], a--);
                var d = null;
                2 <= a && (d = arguments[1]);
            ...
            combineLatest: function () {
                ...
                1 === c.length && x(c[0]) && (c = c[0].slice());
                return function (a) {
                    return a.lift.call(F([a].concat(c)), new Ha(b))
                }
            },
            concat: function () {
                for (var c = [], a = 0; a < arguments.length; a++) c[a] = arguments[a];
            ...
            elementAt: function (c, a) {
                ...
                return function (d) {
                    return d.pipe(H(function (a, b) {
                        return b === c
                    }), Aa(1), b ? ba(a) : ja(function () {
                        return new X
                    }))
                }
            },
            ...
            first: function (c, a) {
                var b = 2 <= arguments.length;
                return function (d) {
                    return d.pipe(c ? H(function (a, b) {
                        return c(a, b, d)
                    }) : J, Aa(1), b ? ba(a) : ja(function () {
                        return new ca
                    }))
                }
            },
            ...
            max: function (c) {
                return ma("function" === typeof c ? function (a, b) {
                    return 0 < c(a, b) ? a : b
                } : function (a, b) {
                    return a > b ? a : b
                })
            ...
            mergeMapTo: function (c, a, b) {
                void 0 === b && (b = Number.POSITIVE_INFINITY);
                if ("function" === typeof a) return L(function () {
                    return c
                }, a, b);
                "number" === typeof a && (b = a);
                return L(function () {
            ...
            publishReplay: function (c, a, b, d) {
                ...
                var e = "function" === typeof b ? b : void 0,
                    f = new W(c, a, d);
                return function (a) {
                    return M(function () {
                            return f
            ...
            repeat: function (c) {
                void 0 === c && (c = -1);
                return function (a) {
                    return 0 === c ? R() : 0 > c ? a.lift(new Bb(-1, a)) : a.lift(new Bb(c - 1, a))
                }
            },
        ...
        Db = function () {
            ...
            c.prototype.logSubscribedFrame = function () {
                this.subscriptions.push(new fa(this.scheduler.now()));
                return this.subscriptions.length - 1
            };
            c.prototype.logUnsubscribedFrame = function (a) {
                var b = this.subscriptions;
                b[a] = new fa(b[a].subscribedFrame, this.scheduler.now())
            };
            return c
        }(),
        Ia = function (c) {
    ...
    var Eb = function (c) {
        ...
        a.prototype._subscribe = function (a) {
            var b = this,
                ...
                f = new t;
            f.add(new t(function () {
                b.logUnsubscribedFrame(e)
            }));
            f.add(c.prototype._subscribe.call(this, a));
            return f
        };
    ...
    var tf = function (c) {
            ...
            a.prototype.expectObservable = function (b, c) {
                ...
                c = a.parseMarblesAsSubscriptions(c, this.runMode);
                var h = c.unsubscribedFrame,
                    k;
                this.schedule(function () {
                    k = b.subscribe(function (a) {
                        var b = a;
                        a instanceof n && (b = d.materializeInnerObservable(b, d.frame));
                        f.push({
                            frame: d.frame,
                ...
                }, c.subscribedFrame === Number.POSITIVE_INFINITY ? 0 : c.subscribedFrame);
                h !== Number.POSITIVE_INFINITY && this.schedule(function () {
            ...
            a.parseMarblesAsSubscriptions = function (a, c) {
                var b = this;
                void 0 === c && (c = !1);
                if ("string" !== typeof a) return new fa(Number.POSITIVE_INFINITY);
                for (var d =
                        a.length, g = -1, h = Number.POSITIVE_INFINITY, k = Number.POSITIVE_INFINITY, m = 0, r = function (d) {
                            ...
                            switch (l) {
                                ...
                                case "^":
                                    ...
                                    break;
                                case "!":
                                    if (k !== Number.POSITIVE_INFINITY) throw Error("found a second subscription point '^' in a subscription marble diagram. There can only be one.");
                                    k = -1 < g ? g : m;
                                    break;
                                default:
                                    if (c && l.match(/^[0-9]$/) && (0 === d || " " === a[d - 1])) {
                                        var r = a.slice(d).match(/^([0-9]+(?:\.[0-9]+)?)(ms|s|m) /);
                                        if (r) {
                                            d += r[0].length - 1;
                            ...
                            m = e;
                            p = d
                        }, n = this, p, q = 0; q < d; q++) r(q), q = p;
                return 0 > k ? new fa(h) : new fa(h, k)
            };
            a.parseMarbles = function (a, c,
                ...
                for (var d = a.length, h = [], k = g ? a.replace(/^[ ]+/, "").indexOf("^") : a.indexOf("^"), m = -1 === k ? 0 : k * -this.frameTimeFactor, n = "object" !== typeof c ? function (a) {
                        return a
                    } : function (a) {
                        return f && c[a] instanceof Ia ? c[a].messages : c[a]
                    }, p = -1, k = function (c) {
                        var d = m,
                            f = function (a) {
                        ...
                        switch (k) {
                            ...
                            case "^":
                                ...
                                break;
                            case "#":
                                l = w.createError(e || "error");
                                f(1);
                                break;
                            default:
                                if (g && k.match(/^[0-9]$/) && (0 === c || " " === a[c - 1])) {
                                    var u = a.slice(c).match(/^([0-9]+(?:\.[0-9]+)?)(ms|s|m) /);
                                    if (u) {
                                        c += u[0].length - 1;
                                        var k = parseFloat(u[1]),
                                            r = void 0;
                                        switch (u[2]) {
                                            case "ms":
                                                r = k;
        ...
        vf = "undefined" !== typeof self && "undefined" !== typeof WorkerGlobalScope && self instanceof WorkerGlobalScope && self,
        wf = "undefined" !== typeof global && global,
        z = "undefined" !== typeof window && window || wf || vf;
    if (!z) throw Error("RxJS could not find any global context (window, self, global)");
    var Hc = B(function (c, a) {
                ...
                var b = c.call(this) || this,
                    e = {
                        ...
                        createXHR: function () {
                            var a;
                            if (this.crossDomain)
                                if (z.XMLHttpRequest) a = new z.XMLHttpRequest;
                                else if (z.XDomainRequest) a = new z.XDomainRequest;
                            else throw Error("CORS is not supported by your browser");
                            else if (z.XMLHttpRequest) a = new z.XMLHttpRequest;
                            else {
                                var b = void 0;
                                try {
                                    for (var c = ["Msxml2.XMLHTTP", "Microsoft.XMLHTTP", "Msxml2.XMLHTTP.4.0"], d = 0; 3 > d; d++) try {
                                        b = c[d];
                                        new z.ActiveXObject(b);
                                        break
                                    } catch (r) {}
        ...
        xf = function (c) {
            function a(a, d) {
                ...
                d.crossDomain || a.getHeader(b,
                    "X-Requested-With") || (b["X-Requested-With"] = "XMLHttpRequest");
                a.getHeader(b, "Content-Type") || z.FormData && d.body instanceof z.FormData || "undefined" === typeof d.body || (b["Content-Type"] = "application/x-www-form-urlencoded; charset\x3dUTF-8");
                d.body = a.serializeBody(d.body, a.getHeader(d.headers, "Content-Type"));
                a.send();
                return a
            }
            h(a, c);
            ...
            a.prototype.send = function () {
                var a =
                    ...
                    c = c.body;
                try {
                    var r = this.xhr = a.createXHR();
                    this.setupEvents(r, a);
                    e ? r.open(f, g, h, e, k) : r.open(f, g, h);
                    h && (r.timeout = a.timeout, r.responseType = a.responseType);
            ...
            a.prototype.serializeBody = function (a, c) {
                if (!a || "string" === typeof a || z.FormData && a instanceof z.FormData) return a;
                if (c) {
                    var b =
                ...
                function (a, c) {
                    ...
                    function g(a) {
                        ...
                        if (4 === this.readyState) {
                            var e = 1223 === this.status ? 204 : this.status,
                                f = "text" === this.responseType ? this.response || this.responseText : this.response;
                            0 === e && (e = f ? 200 : 0);
                            if (400 > e) c && c.complete(), b.next(a), b.complete();
                            else {
                                c && c.error(a);
                                a = void 0;
                                try {
                    ...
                    if (a.upload && "withCredentials" in a) {
                        if (h) {
                            var k;
                            k = function (a) {
                                k.progressSubscriber.next(a)
                            };
                            z.XDomainRequest ? a.onprogress = k : a.upload.onprogress = k;
                            k.progressSubscriber = h
                        }
                        var m;
                        m = function (a) {
                            var b = m.progressSubscriber,
                                c = m.subscriber,
                                d = m.request;
                            b && b.error(a);
                            var e;
                            try {
                                e = new qa("ajax error", this, d)
                            } catch (Ja) {
                                e = Ja
                            }
                            c.error(e)
                        ...
                        m.request = c;
                        m.subscriber = this;
                        m.progressSubscriber =
                            h
                    }
                    a.onreadystatechange = d;
                    d.subscriber = this;
                    d.progressSubscriber = h;
                    d.request = c;
                    a.onload = g;
                    g.subscriber = this;
        ...
        Fb = function () {
            return function (c, a, b) {
                ...
                this.response = mb(this.responseType,
                    a)
            }
        }(),
        qa = function () {
        ...
        Hb = function (c) {
            ...
            a.prototype._resetState = function () {
                this._socket = null;
                this.source || (this.destination = new W);
                this._output = new v
            };
                ...
                function () {
                    ...
                    k.onopen = function (b) {
                        if (a._socket) {
                            ...
                            c && c.next(b);
                            b = a.destination;
                            a.destination = m.create(function (b) {
                                ...
                                function (b) {
                                    ...
                                    c && c.next(void 0);
                                    b && b.code ? k.close(b.code, b.reason) : h.error(new TypeError("WebSocketSubject.error must be called with an object with an error code, and an optional reason: { code: number, reason: string }"));
                                    a._resetState()
                                },
                                function () {
                            ...
                            b && b instanceof W && n.add(b.subscribe(a.destination))
                    ...
                    k.onclose =
                        function (b) {
                            ...
                            c && c.next(b);
                            b.wasClean ? h.complete() : h.error(b)
                        };
            ...
            fromFetch: function (c, a) {
                return new n(function (b) {
                    var d = new AbortController,
                        ...
                        f = !0,
                        g = !1;
                    a ? (a.signal && a.signal.addEventListener("abort", function () {
                        e.aborted || d.abort()
                    }), a.signal = e) : a = {
                        signal: e
                    };
                    fetch(c, a).then(function (a) {
                        f = !1;
                        b.next(a);
                        b.complete()
                    }).catch(function (a) {
    ...
    k.forkJoin = function () {
        ...
        if (1 === c.length) {
            var b = c[0];
            if (x(b)) return ia(b, null);
            if (ra(b) && Object.getPrototypeOf(b) === Object.prototype) return c = Object.keys(b), ia(c.map(function (a) {
                return b[a]
            }), c)
        }
        if ("function" === typeof c[c.length - 1]) {
            var d = c.pop(),
                c = 1 === c.length && x(c[0]) ? c[0] : c;
            return ia(c, null).pipe(B(function (a) {
    ...
    k.generate =
        function (c, a, b, d, e) {
            var f, g;
            1 == arguments.length ? (g = c.initialState, a = c.condition, b = c.iterate, f = c.resultSelector || J, e = c.scheduler) : void 0 === d || A(d) ? (g = c, f = J, e = d) : (g = c, f = d);
            return new n(function (c) {
                var d = g;
                if (e) return e.schedule(Yb, 0, {
                    subscriber: c,
                    iterate: b,
                    condition: a,
                    resultSelector: f,
    ...
    k.pairs = function (c, a) {
        return a ? new n(function (b) {
            ...
            for (var b = Object.keys(c), e = 0; e < b.length && !a.closed; e++) {
                var f = b[e];
                c.hasOwnProperty(f) && a.next([f, c[f]])
            }
            a.complete()
        })
    };
